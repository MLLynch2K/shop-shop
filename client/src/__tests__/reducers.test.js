...
//This test will remove both cart items from initialState, one after the
// other. We want to test the removal of both because removing the last
// item from the cart should also close it (i.e., set cartOpen to false).
...
/*In this test, we want to ensure that only the first item's quantity is updated,
 because its _id matches the _id given to the reducer() function. The second item's
